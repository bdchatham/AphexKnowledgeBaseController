...
import (
	...
	kbcontroller "github.com/bdchatham/AphexKnowledgeBaseController/controller"
)
...
func run() int {
	...
	mgrOpts := ctrl.Options{
		...
		LeaderElectionID:        "knowledgebase-controller.aphex.io",
	...
	if err = (&kbcontroller.KnowledgeBaseReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Log:    ctrl.Log.WithName("controllers").WithName("KnowledgeBase"),
	...
	setupLog.Info("Starting KnowledgeBase controller",
		"leaderElection", enableLeaderElection,
